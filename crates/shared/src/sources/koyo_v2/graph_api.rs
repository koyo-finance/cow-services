//! Module containing The Graph API client used for retrieving Koyo weighted
//! pools from the Koyo V2 subgraph.
//!
...
use crate::{
    event_handling::MAX_REORG_BLOCK_COUNT, sources::balancer_v2::swap::fixed_point::Bfp,
...
/// A client to the Koyo V2 subgraph.
///
...
pub struct KoyoSubgraphClient(SubgraphClient);

impl KoyoSubgraphClient {
...
/// Pool data from the Koyo V2 subgraph.
