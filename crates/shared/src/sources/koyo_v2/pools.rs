//! Abstraction around a Koyo pool factory.
//!
...
//!
//! This abstraction is provided in a way to simplify adding new Koyo pool
//! types by just implementing the required `KoyoFactory` trait.
...
/// A Koyo factory indexing implementation.
#[mockall::automock(
